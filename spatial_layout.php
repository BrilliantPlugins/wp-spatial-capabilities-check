...
<p>
<?php
printf( esc_html__('Your database version is %1$s.','wp_spatial_capabilities_check'), '<strong>' .  $version_info->v . '</strong>');
?>
</p>
<p>
<?php
...
if( isset( $capabilites_table ) ) {
	...
	echo '<p>' . esc_html__('The capabilities table could not be generated.','wp_spatial_capabilities_check') . '</p>';
}
?>
</div>
</div>
